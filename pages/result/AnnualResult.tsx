...
myform = createRef();
class AnnualResult extends Component<any, any> {
  ...
  onFinish = async (values: any) => {
    ...
    await checkAnnualResult(this.state.studentDetail.id)
  ...
  render() {
    const { t } = this.props.i18n;
    const { section, studentClass, subjects, studentDetail } = this.state;
    if (
      !section ||
      !studentClass ||
      !studentDetail ||
...
export default withAuth(withTranslation(AnnualResult, "common"));
